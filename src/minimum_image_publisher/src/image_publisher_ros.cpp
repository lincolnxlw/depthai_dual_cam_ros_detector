  ...
  nh_("~")
{
  ...
  dai::rosBridge::ImgDetectionConverter right_cam_det_converter("/right_cam_frame", 1920, 1080, false);
  ...
  dai::rosBridge::BridgePublisher<sensor_msgs::Image, dai::ImgFrame> left_cam_image_publisher(
      ...
      std::bind(&dai::rosBridge::ImageConverter::toRosMsg,
                ...
                std::placeholders::_2),
      10, "", "");
  dai::rosBridge::BridgePublisher<vision_msgs::Detection2DArray, dai::ImgDetections> right_cam_det_publisher(
      right_cam_detection_q,
      nh_,
      std::string("/right_cam/detections"),
      std::bind(&dai::rosBridge::ImgDetectionConverter::toRosMsg,
                &right_cam_det_converter,
                std::placeholders::_1,
                std::placeholders::_2),
      10);
  ...
  right_cam_det_publisher.addPublisherCallback();
